...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-muted/30" style={{ fontFamily: "'General Sans', 'Inter', sans-serif" }}>
      ...
      <main className="max-w-2xl mx-auto px-4 py-12">
        <h1 className="text-2xl font-bold text-gray-900 mb-2 dark:text-foreground">Privacy Policy</h1>
        <p className="text-sm text-gray-500 mb-8 dark:text-muted-foreground">Last updated: April 14, 2026</p>

        <div className="prose prose-sm prose-gray max-w-none space-y-6 text-gray-700 leading-relaxed dark:text-foreground/90">
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2 dark:text-foreground">1. Introduction</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2 dark:text-foreground">2. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2 dark:text-foreground">3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2 dark:text-foreground">4. Data Storage &amp; Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2 dark:text-foreground">5. Data Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2 dark:text-foreground">6. Cookies &amp; Local Storage</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2 dark:text-foreground">7. Your Rights</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2 dark:text-foreground">8. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2 dark:text-foreground">9. Contact</h2>
            <p>
